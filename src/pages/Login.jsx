...
export default function Login() {
  ...
  const signInWithGoogle = async () => {
    const { error } = await supabase.auth.signInWithOAuth({
      provider: 'google',
      options: {
        redirectTo: window.location.origin + '/auth/callback', // Redirects back to your app after sign-in
      },
    });
      ...
      <div className="w-full max-w-md">
        <div className="card bg-base-100 shadow-2xl">
          <div className="card-body">
            ...
            {/* Google Login */}
            <button className="btn bg-white text-black border-[#e5e5e5] w-full" onClick={signInWithGoogle}>
